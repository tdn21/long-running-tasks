...
router.get('/team/start', (req, res) => {
    ...
    tasks[userId]["task"] = fork('./src/jobs/team.js', [arg], {stdio : [process.stdin, process.stdout, process.stderr, 'pipe', 'ipc']});
...
router.get('/team/resume', (req, res) => {
    ...
    tasks[userId]["task"] = fork('./src/jobs/team.js', [tasks[userId].state], {stdio : [process.stdin, process.stdout, process.stderr, 'pipe', 'ipc']});
